    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lab', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_tools', to='home.labpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tool', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_tool_specifications', to='home.tool')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
